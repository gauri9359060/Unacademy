  ...
  return (
    <div className={styles.Subscription}>
      ...
      <div className={styles.subsHead}>
        <h5 className={styles.subsH5}>UPSC CSE - GS</h5>
        <p className={styles.subsP}>
        ...
        <div className={styles.Subscription} >
          ...
          <div className={styles.CourseBenifits}>
            <ul className={styles.plusbenifitList}>
              <li>
                <img
                  src="https://static.uacdn.net/production/_next/static/images/greenTick.png?q=75&w=48"
                  alt=""
                  width="12%"
                />
        ...
        <div className={styles.IconicSubscription}>
          <div className={styles.iconicHeadings}>
            ...
            <div style={{ padding: "3%", marginLeft: "5%" }}>
              <img
                src="https://unacademy-prod.s3.ap-southeast-1.amazonaws.com/web-cms/Group_4894_2b74e644b9.png"
                alt=""
                width="55%"
              />
            </div>
          ...
          <div className={styles.CourseBenifits}>
            ...
            <ul className={styles.plusbenifitList}>
              <li>
                <img
                  src="https://static.uacdn.net/production/_next/static/images/yellowTick.png?q=75&w=48"
                  alt=""
                  width="12%"
                />
                1:1 Live Mentorship
